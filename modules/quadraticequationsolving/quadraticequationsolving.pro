#-------------------------------------------------
#
# Project created by QtCreator 2017-12-14T09:24:38
#
#-------------------------------------------------
...
unix:TARGET = quadraticequationsolving
win32:TARGET = ../../../dist/bin/quadraticequationsolving

TEMPLATE = lib

DEFINES += QUADRATICEQUATIONSOLVING_LIBRARY
...
SOURCES += \
        quadraticequationsolving.cpp

HEADERS += \
        quadraticequationsolving.h \
        quadraticequationsolving_global.h 
